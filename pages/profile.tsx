    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-gray-200 hover:border-black transition-all duration-300 animate-fade-in">
          {/* Enhanced Header */}
          <div className="bg-gradient-to-r from-black via-gray-800 to-black px-8 py-16 relative overflow-hidden">
            <div className="absolute inset-0 bg-white/5"></div>
            <div className="relative flex items-center justify-between">
              <div className="group relative">
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-3xl font-bold text-black shadow-2xl border-4 border-white">
                  {user.name.charAt(0).toUpperCase()}
                </div>
                <div className="absolute inset-0 rounded-full border-4 border-white/20"></div>
              </div>
              <div className="flex-1 ml-6">
                <h1 className="text-6xl font-bold text-white font-display bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                  {user.name}
                </h1>
                <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-bold ${getRoleBadgeColor(user.role)} shadow-lg`}>
                  <span className="mr-2">
