    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black group cursor-pointer font-display">
              How{" "}
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto font-medium hover:text-black transition-colors duration-300 font-body">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loadingComments ? (
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-gray-600 font-medium font-body">
                Loading reviews...
              </p>
            </div>
          ) : comments.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {comments.map((comment: Comment) => (
                <div
                  key={comment._id}
                  className="group bg-white border-4 border-gray-200 rounded-3xl p-8 hover-lift animate-fade-in cursor-pointer hover:border-black transition-all duration-300 shadow-lg hover:shadow-2xl"
                >
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                      <span className="text-2xl text-white font-bold font-heading">
                        {comment.user?.name?.charAt(0) || "U"}
                      </span>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-black group-hover:text-gray-700 transition-colors duration-300 font-heading">
                  ...
                  <p className="text-gray-700 leading-relaxed font-medium group-hover:text-black transition-colors duration-300 text-lg mb-4 font-body">
                    {comment.content}
                  </p>
                  <div className="flex items-center justify-between">
                    <div className="flex text-yellow-400">
                      {[...Array(5)].map((_, i) => (
                        <svg
                          key={i}
                          className={`w-5 h-5 ${i < comment.rating ? "fill-current" : "fill-gray-300"}`}
                          viewBox="0 0 20 20"
                        >
                    ...
                    <span className="text-sm text-gray-500 font-medium font-body">
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold text-gray-600 mb-4 font-heading">
                No Reviews Yet
              </h3>
              <p className="text-gray-500 font-body">
                Be the first to share your experience with SafeTails!
              </p>
            </div>
          )}
      ...
      <section className="py-20 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto font-medium font-body">
