...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      ...
      >
        <h2 className="text-4xl mb-8 font-bold text-center text-black font-display">
          Login
        </h2>
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-lg font-semibold text-gray-700 mb-2 font-heading">
              Email
            </label>
            <input
              type="email"
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <svg
                    className="w-6 h-6 text-gray-500 group-hover:text-black transition-colors duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
