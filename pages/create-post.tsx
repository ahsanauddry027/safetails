        ...
        reader.onload = async (event) => {
          ...
          try {
            ...
            if (response.data.success) {
              console.log(
                "Image uploaded successfully, URL length:",
                response.data.imageUrl.length
              );
              setFormData((prev) => ({
                ...prev,
    ...
    try {
      ...
      console.log("Submitting post data:", {
        ...
        images: postData.images.map(
          (img, i) => `Image ${i + 1}: ${img.length} chars`
        ),
      });
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {["missing", "emergency", "wounded", "vet-consultant"].map(
                    (type) => (
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <svg
                          className="w-12 h-12 text-gray-400 group-hover:text-black transition-colors duration-300 mb-4"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <p className="text-lg font-semibold text-gray-600 group-hover:text-black transition-colors duration-300">
                          {uploadingImage
                            ? "Uploading..."
                            : "Click to upload pet photos"}
                        </p>
                        <p className="text-sm text-gray-500 mt-2">
                          Upload up to 5 images (PNG, JPEG, JPG only, max 2MB
                          each)
                        </p>
                      </div>
                    </button>
