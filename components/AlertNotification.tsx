        ...
        navigator.geolocation.getCurrentPosition(
          async (position) => {
            ...
            const response = await axios.get(
              `/api/alerts?latitude=${lat}&longitude=${lng}&radius=10&status=active&limit=${maxNotifications}`
            );
            ...
            if (response.data.success) {
              ...
              if (newAlerts.length > 0) {
                setNotifications((prev) =>
                  [...newAlerts, ...prev].slice(0, maxNotifications)
                );
      ...
      >
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M15 17h5l-5 5v-5zM4.5 19.5h15a2.5 2.5 0 002.5-2.5V9.5a2.5 2.5 0 00-2.5-2.5h-15A2.5 2.5 0 002 9.5v7.5a2.5 2.5 0 002.5 2.5z"
          />
        </svg>
        ...
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 max-h-96 overflow-y-auto">
          <div className="p-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">
              Recent pet-related activities in your area
            </p>
          </div>
