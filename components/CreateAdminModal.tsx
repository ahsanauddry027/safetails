      ...
      <div className="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-2xl rounded-2xl bg-white">
        <div className="mt-3">
          ...
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-bold text-gray-900">Create New Admin User</h3>
            <button
              onClick={onClose}
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div className={`flex items-center ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>
                ...
                <span className="ml-2 text-sm font-medium">Details & Permissions</span>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-4">Admin Permissions</label>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
